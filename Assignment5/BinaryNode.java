...
public class BinaryNode<T> {
    ...
    public String printTree(String prefix, BinaryNode<T> n, boolean isLeft) {
        String ans = "";
        if (n != null) {
            ans = prefix + (isLeft ? "|-- " : "\\-- ") + n.data + '\n';
            ans += printTree(prefix + (isLeft ? "|   " : "    "), n.left, true);
            ans += printTree(prefix + (isLeft ? "|   " : "    "), n.right, false);
        }
        return ans;
    }
